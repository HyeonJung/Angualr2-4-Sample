...
var CarPartsComponent = (function () {
    ...
    CarPartsComponent.prototype.ngOnChanges = function () {
        console.log("hi");
    };
    ...
    CarPartsComponent.prototype.showAlert = function (str) {
        alert(str);
    };
    CarPartsComponent.prototype.filtering = function (value) {
        this.carParts = mocks_1.CARPARTS.filter(function (carPart) { return carPart.inStock > value; });
    };
